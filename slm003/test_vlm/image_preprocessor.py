...
"""
# Convert to PNG (removes EXIF and progressive encoding)
python image_preprocessor.py dog_in_guitar_case_256_256.jpg -f PNG

# Or convert to simplified JPEG
python image_preprocessor.py dog_in_guitar_case_256_256.jpg -f JPEG -q 80
"""
